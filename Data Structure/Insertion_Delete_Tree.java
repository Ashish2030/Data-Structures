import java.util.*;
public class Insertion_Delete_Tree
{ 
   static Node head;
     static  Node temp;
    Node prev1;
...
// Deletion Start  when address is given 
...
// Deletion Start  when value is given 
...
public static void main(String arg[])
    {
        Insertion_Delete_Tree b = new Insertion_Delete_Tree();
